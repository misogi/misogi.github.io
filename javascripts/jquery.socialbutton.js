...
$.fn.socialbutton = function(service, options) {
	...
	var defaults = {
		...
		evernote: {
			button: 'article-clipper', // article-clipper, article-clipper-remember, article-clipper-jp, article-clipper-rus, article-clipper-fr, site-mem-32, site-mem-36, site-mem-22, site-mem-16
			url: '', // document.URL
			encoded: true,
...
function socialbutton_evernote(target, options, defaults, index, max_index)
{
	...
	if (button == 'article-clipper' || button == 'article-clipper-remember' ||
		button == 'article-clipper-jp' || button == 'article-clipper-rus' || button == 'article-clipper-fr' ||
		button == 'site-mem-32' || button == 'site-mem-36' || button == 'site-mem-22' || button == 'site-mem-16') {
